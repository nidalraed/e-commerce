...
function Footer() {
  ...
  {/* Main footer */}
  <div className="pt-16 pb-12 text-sm border-t border-bg-orange-600 bg-orange-500">
        ...
        >
          ...
          <ul>
            ...
            <li className="mb-2 leading-6">
              <a
                href="#"
                className="transition-colors duration-300 hover:text-white focus:text-white-100"
              >
                {" "}
                Pricing{" "}
              </a>
  ...
  <div className="py-4 text-sm border-t border-bg-orange-600 bg-orange-500">
    <div className="container px-6 mx-auto">
      <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
